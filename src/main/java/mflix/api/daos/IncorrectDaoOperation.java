...
/**
 * Runtime exception to be thrown in cases where a Dao layer operation cannot be successfully performed, or as Database layer exception encapsulation.
 */
public class IncorrectDaoOperation extends RuntimeException {

    /**
     * Creates an exception for incorrect Dao layer operations.
     *
