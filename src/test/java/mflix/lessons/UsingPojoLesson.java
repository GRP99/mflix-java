...
public class UsingPojoLesson extends AbstractLesson {
   ...
   */
    ...
    public void testReadObjectsWithCustomCodec() {
        ...
        MongoCollection<Document> actorsCollectionDoc = testDb.getCollection("actors");
        ActorWithStringId mappedActor = fromDocument(Objects.requireNonNull(actorsCollectionDoc.find(queryFilter).iterator().tryNext()));
     ...
     * example below to demonstrate to write.
     */
    ...
    public void testReadObjectWithCustomFieldCodec() {
                ...
                fromRegistries(
                        ...
                        fromProviders(
                                PojoCodecProvider.builder()
                                        ...
                                        .automatic(true)
                                        .build()));
        // we're done! Let's test if it worked! let us get the actors collection
        ...
        ActorWithStringId mappedActor =
                fromDocument(Objects.requireNonNull(actorsCollectionDoc.find(queryFilter).iterator().tryNext()));
     ...
     *
     * 4. Handling of generics and documents is cleaner and easier to
