...
public class BasicReads extends AbstractLesson {
    ...
    public void testCanFindOne() {
        ...
        MongoCursor<Document> cursor = moviesCollection.find(new Document()).limit(1).iterator();
        ...
        Assert.assertNotEquals("should not be null", null, actual);
     ...
     *
     * <p>The Collection object also has projection functionality, but the usage is different from
     * that of the mongodb shell.
     */
    @Test
     ...
     * match a query filter. We also saw how to include only the fields we
