...
/**
 * @see <a
 * href="<a href="https://docs.mongodb.com/manual/reference/operator/meta/natural/index.html">https://docs.mongodb.com/manual/reference/operator/meta/natural/index.html</a>">$natural</a>
 */
@SpringBootTest
public class CursorMethodsAndAggEquivalents extends AbstractLesson {

    private final MongoCollection<Document> sortable;
    ...
    public void testFindSortAndSkip() {
        ...
        // This means that using skip on its own, without determining a
    ...
    public void testLimitAndBatchSize() {
        ...
        int count = 0;
        for (Document ignored : limitedBatched) {
            count++;
        }
     ...
     * aggregation stages are applied does!
     */
    @After
